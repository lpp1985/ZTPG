(function() {
  ...
  d3.random = {
    normal: function(碌, 蟽) {
      ...
      return function() {
        ...
        return 碌 + 蟽 * x * Math.sqrt(-2 * Math.log(r) / r);
      };
    },
    logNormal: function(碌, 蟽) {
      var n = arguments.length;
      if (n < 2) 蟽 = 1;
      if (n < 1) 碌 = 0;
      var random = d3.random.normal();
      return function() {
        return Math.exp(碌 + 蟽 * random());
      };
    },
  ...
  var d3_formatPrefixes = [ "y", "z", "a", "f", "p", "n", "渭", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" ].map(d3_formatPrefix);
